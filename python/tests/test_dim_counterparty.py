...
from src.dim_counterparty import (dim_counterparty_data_frame, create_and_push_parquet, main)
import tempfile
...
def create_mock_s3():
    with mock_s3():
        ...
        csv_data2 = "1,6826 Herzog Via,,Avon,New Patienceburgh,28441,Turkey,1803 637401,2022-11-03 14:20:49.962000,2022-11-03 14:20:49.962000"
