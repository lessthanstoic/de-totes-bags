...
from python.transformation_function.src.dim_staff import (dim_staff_data_frame, create_and_push_parquet, main)
import tempfile
...
def test_if_the_parquet_file_was_created_in_the_process_bucket(create_mock_s3):
    ...
    response = s3.get_object(Bucket='processed-data-vox-indicium', Key='dim_staff.parquet')
